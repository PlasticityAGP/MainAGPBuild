...
public class FlockChild : MonoBehaviour
{
    ...
    [SerializeField]
    private bool ControlledByBolt;
    //[HideInInspector]
    [Tooltip("Only set this for birds not spawned by a spawner")]
    public FlockController _spawner;			//Reference to the flock controller that spawned this bird
    //[HideInInspector]
    private Vector3 _wayPoint;				//Waypoint used to steer towards
